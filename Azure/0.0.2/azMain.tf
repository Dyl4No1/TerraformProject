...
##### azuread user accounts, needs RBAC
# resource "azuread_user" "Admin" {
#   user_principal_name = "Admin@hashicorp.com"
#   display_name        = "Admin"
#   mail_nickname       = "Admin"
#   password            = "Password1234!" ### for showcase purposes
# }
...
# }
# resource "azuread_user" "Guest" {
#   user_principal_name = "Guest@hashicorp.com"
#   display_name        = "Guest"
#   mail_nickname       = "Guest"
#   password            = "Password1234!"
# }
...
# resource "azurerm_subscription" "web" {
#   subscription_name = "web"
#   subscription_id = azurerm_subscription.web.id # must be UUID
# }
# resource "azurerm_subscription" "sql" {
#   subscription_name = "sql"
#   subscription_id = azurerm_subscription.sql.id
# }
# resource "azurerm_subscription" "storage" {
#   subscription_name = "stor"
...
resource "azurerm_virtual_network" "iBeacon-vnet" {
  name                = "iBeacon-vnet"
...
resource "azurerm_subnet" "webSubnet" { ## web subnet
  ...
  resource_group_name  = azurerm_resource_group.rg.name
  virtual_network_name = azurerm_virtual_network.iBeacon-vnet.name
...
resource "azurerm_subnet" "storSubnet" { ## storage subnet
  name                 = "storSubnet"
  resource_group_name  = azurerm_resource_group.rg.name
  virtual_network_name = azurerm_virtual_network.iBeacon-vnet.name
...
## RBAC ? NEEDS DOING
## create 3 different subscription/resource groups(gcp tenants/account). Admin, User, Guest DONE
## Management group > subscription > resource group DONE
